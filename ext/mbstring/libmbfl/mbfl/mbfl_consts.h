...
#define MBFL_ENCTYPE_WCS2BE		0x00000010 /* 2 bytes/char, high byte first */
#define MBFL_ENCTYPE_WCS2LE		0x00000020 /* 2 bytes/char, low byte first */
#define MBFL_ENCTYPE_MWC2BE		0x00000040 /* 2+ bytes/char, high byte first */
#define MBFL_ENCTYPE_MWC2LE		0x00000080 /* 2+ bytes/char, low byte first */
#define MBFL_ENCTYPE_WCS4BE		0x00000100 /* 4 bytes/char, high byte first */
#define MBFL_ENCTYPE_WCS4LE		0x00000200 /* 4 bytes/char, low byte first */
